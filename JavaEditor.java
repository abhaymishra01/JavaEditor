...
public class JavaEditor extends JFrame implements ActionListener, KeyListener {
    JFrame jf;
    JMenuBar mb;
    ...
    public JavaEditor() {
		...
		mFileMenuItem[0].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X, ActionEvent.CTRL_MASK));
		mFileMenuItem[1].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C, ActionEvent.CTRL_MASK));
		mFileMenuItem[2].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_V, ActionEvent.CTRL_MASK));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            if (ae.getActionCommand().equals("open")) {
                ...
                jf.setTitle("Editor 2023:" + fd.getFile());
                ...
                if (textchange == true) {
                    ask = JOptionPane.showConfirmDialog(this, "Text has been changed.\nDo you want to save it",
                            "ChangesSave", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE);
                    if (ask == 0) {
                        SaveButtonCoding();
                        System.exit(0);
                    } else if (ask == 1)
                ...
                /*
                 * JFontChooser fontChooser = new FontChooser();
                 * int retValue = fontChooser.showDialog(null);
                 * //get the selected font
                 * if(retValue==fontChooser.OK_OPTION){
                 * Font selected = fontChooser.getSelectionFont();
                ...
                if (!filename.equals("")) {
                    ...
                    try {
                        result = "";
                        Process error = r
                                .exec("C:\\Program Files\\Java\\jdk1.8.0_202\\bin\\javac.exe " + filename);
                        ...
                        if (result.equals("")) {
                            ta1.setText("Compilation Succesfull" + filename);
                            err.close();
                        } else
                            ta1.setText(result);
                    } catch (Exception e1) {
                ...
                if (!fname.equals("")) {
                    try {
                        ...
                        Process p = r.exec("C:\\Program Files (x86)\\Java\\jdk1.8.0_301\\bin\\javac.exe -cp .  " + fn);
                ...
                String h1 = "This Editor  Project has been Created by Programmer @bhay-mishra";
                JOptionPane.showMessageDialog(this, h1);
            } else if (ae.getActionCommand().equals("Font")) {
                /*
                 * JFontChooser fd = new JFileChooser(this,ta.getFont());
                 * fd.show();
    ...
    public void SaveButtonCoding() {
        try {
            if (jf.getTitle().equals("Editor 2023: Untitled")) {
